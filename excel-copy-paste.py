# -*- coding: utf-8 -*-
"""
Created on Thu Aug  6 10:40:57 2020

This code aims at reading several input excel files, 
extracting part of the data in the each sheet in input files,
and recombine the data, then paste new data to selected region in the sheets in output file(excel)
